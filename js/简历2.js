...
function printer() {
    ...
    } else if (str[i - 6] + str[i - 5] + str[i - 4] + str[i - 3] + str[i - 2] + str[i - 1] == "787362") {
    ...
    } else if (str[i - 6] + str[i - 5] + str[i - 4] + str[i - 3] + str[i - 2] + str[i - 1] == "dd9a10") {
        highlight('body |html |.comment |.selector|dialog ');
    } else if (str[i - 6] + str[i - 5] + str[i - 4] + str[i - 3] + str[i - 2] + str[i - 1] == "64D5EA") {
        highlight('.key ');
        highlight3(' -webkit-transition | transition |overflow |backgroundcolor |border |max-height |width |font-size |font-family |padding |box-shadow |outline |position |float |color  ');
    } else if (str[i - 6] + str[i - 5] + str[i - 4] + str[i - 3] + str[i - 2] + str[i - 1] == "ad7ada") {
        highlight('.value');
        highlight3('color  ');
        highlight4('all 1s| 1px solid #ccc|relative| 14px| monospace| 10px 10px 20px|-10px 10px 5px 0|#787362 |#dd9a10 |#64D5EA |right | 44.6% | 49% |0 |#3f5263 | #303030|auto |white |#ad7ada ');
